            ...
            >
              <div className=" flex gap-5 flex-wrap">
                ...
                <div className=" md:w-[48%] w-[100%]">
                   ...
                   <select   name={"gender"} id="gender" className="outline-none bg-lightGray border w-full py-3  p-2.5 text-primary  text-lg placeholder:text-primary rounded-md">
